package io.bitbucket.plt.sdp.bohnanza.Game;

import io.bitbucket.plt.sdp.bohnanza.BeanField.BeanFieldModel;
import io.bitbucket.plt.sdp.bohnanza.Cards.*;
import io.bitbucket.plt.sdp.bohnanza.Deck.DeckModel;
import io.bitbucket.plt.sdp.bohnanza.Player.*;
import io.bitbucket.plt.sdp.bohnanza.State.GameContext;
        ...
        for (PlayerModel player : players) {
            ...
            for (int i = 0; i < 5; i++) {
                if (!beanCards.isEmpty()) {
                    BeanCard cardToDeal = beanCards.removeLast(); // Remove the first card from the list
